...
/** Línea 4 del hero: continuidad / retorno. Rol = "volvé a ver qué pasó". ~30 frases por idioma. */
export const READING_SUMMARY_STEADY = {
  en: [
    ...
    "The read goes on.",
    "Come back tomorrow—the field will be different.",
    "Something new is forming in the field.",
    "The sky won't look the same tomorrow.",
    "Signals are still arriving.",
    "The reading is unfolding.",
    "Come back and see what changed.",
    "The field is shifting again.",
    "Moments keep landing.",
    "The pattern is still forming.",
    "The atmosphere is still moving.",
    "What rises next may surprise you.",
    "More signals are on the way.",
    "The window keeps changing.",
    "This field never stays the same.",
    "Tomorrow's reading will be different.",
    "The sky keeps evolving.",
    "The signal stream continues.",
    "Something else may rise soon.",
    "The observatory is still listening.",
  ...
  es: [
    ...
    "La lectura continúa.",
    "Volvé mañana—el campo será otro.",
    "Algo nuevo se está formando en el campo.",
    "Mañana el cielo no se verá igual.",
    "Las señales siguen llegando.",
    "La lectura se despliega.",
    "Volvé a ver qué cambió.",
    "El campo se mueve de nuevo.",
    "Los momentos siguen aterrizando.",
    "El patrón sigue formándose.",
    "La atmósfera sigue en movimiento.",
    "Lo que suba después puede sorprenderte.",
    "Hay más señales en camino.",
    "La ventana sigue cambiando.",
    "Este campo nunca es el mismo.",
    "La lectura de mañana será otra.",
    "El cielo sigue evolucionando.",
    "La corriente de señales continúa.",
    "Algo más puede subir pronto.",
    "El observatorio sigue escuchando.",
    "El campo aún no se asentó.",
    "Mirá de nuevo más tarde.",
