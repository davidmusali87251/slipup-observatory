...
(function () {
  ...
  const LABELS = {
    en: {
      quiet: ["quiet field", "field calm", "field quiet", "Observation ongoing", "low signal", "calm horizon"],
    ...
    es: {
      quiet: ["campo tranquilo", "campo en calma", "campo quieto", "Observación en curso", "señal baja", "horizonte quieto"],
