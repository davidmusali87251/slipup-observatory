...
const COPY_VARIANTS = {
  clear: {
    ...
    horizon: {
      ...
      trendShift: [
        ...
        "Surface trend is reordering in this window.",
      ...
      driftCondensing: [
        ...
        "Surface pressure is still tightening.",
      ...
      driftClearing: [
        ...
        "Surface pressure is opening out.",
      ...
      driftStable: [
        ...
        "Surface metrics remain in balanced range.",
  ...
  poetic: {
    ...
    horizon: {
      empty: [
        "Surface metrics still have no shared entries.",
        "No dominant short-window signal is visible yet.",
        "Surface read is waiting for first usable volume.",
        "Trend and mix are still undefined here.",
        "Not enough recent input for a surface line.",
      ],
      early: [
        "Surface metrics are still in early formation.",
        ...
        "Current surface line remains low-confidence.",
      ],
      dominant: [
        ...
        (kind) => `Surface metrics currently favor ${kind}.`,
        (kind) => `This interval is mostly driven by ${kind}.`,
        (kind) => `Primary short-window behavior is ${kind}.`,
        (kind) => `Current surface signal skews to ${kind}.`,
      ],
      trendSteady: [
        "Stability index remains in steady range.",
        "Recent-entry rhythm stays consistent.",
        "Surface trend is stable across intervals.",
      ...
      trendShift: [
        "Stability index is showing active change.",
        "Recent-entry rhythm is still shifting.",
        "Surface trend is reordering now.",
      ...
      driftCondensing: [
        ...
        "Surface pressure is tightening now.",
        "Condensing behavior persists in this interval.",
      ],
      driftClearing: [
      ...
      driftStable: [
        ...
        "Surface metrics remain balanced.",
